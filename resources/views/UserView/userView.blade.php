...
<head>
    ...
    <title>BBMKG Wilayah 1 Medan</title>
                        ...
                        <div class="hero-copy">
                            <div class="container-sm">                                
                                <div class="col-12" style="margin-top:-150px;">
                                    <img style="width:67px; height:80px;" src="https://cdn.bmkg.go.id/Web/Logo-BMKG-new.png" alt="" srcset="">
                                </div>
                                <div class="col-12 text-white" style="margin-top:80px;"></div>
                                <span class="fs24 mt-0 is-revealing"></span><br>
                                <h3 class="hero-title h2-mobile mt-0 is-revealing">BBMKG Wilayah 1 Medan</h3>
                                <p class="hero-paragraph is-revealing" style="font-size:30px;">Instrumentasi dan Kalibrasi</p>
                                <p class="hero-paragraph is-revealing">Silahkan masukkan nomor order anda untuk melakukan pencarian.</p>
                                <form action="{{url('user-pesanan-retrive')}}" method="post">@csrf
                                    <div class="hero-form newsletter-form field field-grouped is-revealing">
                                        <div class="control control-expanded">
                                            <input class="input" type="text" name="no_order" placeholder="No. Order&hellip;">
                                        </div>
                                        <div class="control">
                                            <button type="submit" class="button button-primary button-block button-shadow">Cari</button>
                                        </div>
                                        <!-- <div class="control">
                                            <button type="submit" class="button button-primary button-block button-shadow">Info Tarif</a>
                                        </div> -->
                                    </div>
                                </form>
                            </div>
        ...
        <footer class="site-footer text-light">
            <div class="container">
                <!-- <div class="site-footer-inner">
                    ...
                    <div class="footer-copyright">Copyright © 2019 BMKG.</div>
                </div> -->
            </div>
        </footer>
    </div>
